...
GUIObject.MainFrame.Size = UDim2.new(0.82, 0, 0.70, 0)
...
mainSize.MaxSize = Vector2.new(680, 523)
mainSize.MinSize = Vector2.new(340, 260)
...
CardPos(GUIObject.PlayerFrame, 1, 1, 1, 7, 0.02, 0.015)
Bento(GUIObject.PlayerFrame, P.Input, 0.10)
...
-- Row 2: Bundle search
CardPos(GUIObject.BundleFrame, 2, 1, 1, 7)
Bento(GUIObject.BundleFrame, P.Input, 0.10)
...
GUIObject.BundleText.Size = UDim2.new(0.30, 0, 0.6, 0)
...
GUIObject.BundleSearch.Size = UDim2.new(0.65, 0, 0.7, 0)
BentoInput(GUIObject.BundleSearch, "Tìm bộ outfit…")

-- Row 3: Delay input
CardPos(GUIObject.DelayFrame, 3, 1, 1, 7)
Bento(GUIObject.DelayFrame, P.Input, 0.10)
...
-- Row 4: 2 toggle buttons
CardPos(GUIObject.AutoExecuteFrame, 4, 1, 2, 7)
Bento(GUIObject.AutoExecuteFrame, P.Info, 0.10)
...
CardPos(GUIObject.BundleBodyColorFrame, 4, 2, 2, 7)
Bento(GUIObject.BundleBodyColorFrame, P.Info, 0.10)
...
BentoBtn(GUIObject.BundleBodyColorButton, "Màu theo bộ outfit")
GUIObject.BundleBodyColorButton.TextStrokeColor3 = P.Off

-- Row 5: Execute + Reset (primary actions)
CardPos(GUIObject.ExecuteFrame, 5, 1, 2, 7)
Bento(GUIObject.ExecuteFrame, P.Action, 0.10)
...
CardPos(GUIObject.ResetFrame, 5, 2, 2, 7)
Bento(GUIObject.ResetFrame, P.Warn, 0.10)
...
-- Row 6: Tone + Destroy
CardPos(GUIObject.ToneFrame, 6, 1, 2, 7)
Bento(GUIObject.ToneFrame, P.Info, 0.10)
...
CardPos(GUIObject.DestroyFrame, 6, 2, 2, 7)
Bento(GUIObject.DestroyFrame, P.Danger, 0.10)
...
local normalSize = UDim2.new(0.82, 0, 0.70, 0)
local miniSize = UDim2.new(0.30, 0, 0.06, 0)
